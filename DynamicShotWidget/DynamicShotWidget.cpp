...
void DynamicShotWidget::mouseMoveEvent(QMouseEvent* event)
{
	...
	if (mIsPress)
	{
        ...
        else
        {
            ...
            switch (mZoomFlag)//�ı䴰�ڵĴ�С
            {

            case 0x11:tempRect.setTopLeft(tempRect.topLeft() + ptemp); break;//���Ͻ�
            case 0x31:tempRect.setTopRight(tempRect.topRight() + ptemp); break;//���Ͻ�
            case 0x13:tempRect.setBottomLeft(tempRect.bottomLeft() + ptemp); break;//���½�
            case 0x33:tempRect.setBottomRight(tempRect.bottomRight() + ptemp); break;//���½�
            case 0x21:tempRect.setTop(tempRect.top() + ptemp.y()); break;//���Ͻ�
            case 0x12:tempRect.setLeft(tempRect.left() + ptemp.x()); break;//�����
            case 0x32:tempRect.setRight(tempRect.right() + ptemp.x()); break;//���ҽ�
            case 0x23:tempRect.setBottom(tempRect.bottom() + ptemp.y()); break;//���½�
            }
...
void DynamicShotWidget::setCursorType(int flag)//�����������λ�øı����ָ����״
{
